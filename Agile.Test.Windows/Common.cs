...
namespace Agile.Test.Windows
{
    public static class Common
    {
        public static MainWindowProxy OpenAndLogin(string userName, string password)
        {
            AutomationElement loginElement = FindOpenWindow("Welcome to Agile");

            Process process = null;
            if (loginElement == null)
            {
                process = Process.Start(@"D:\Signum\Agile\Agile.Windows\bin\Debug\Agile.Windows.exe");
